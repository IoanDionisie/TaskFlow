export const TUTORIAL_STEPS = {
    ...
    finishList: "Now that all the tasks of this list are completed, you can also move the list to completed, by pressing the pulsating button from the list's dropdown!",
